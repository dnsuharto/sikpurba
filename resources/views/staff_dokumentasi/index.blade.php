...
<div class="row">
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
            <span class="info-box-icon bg-purple"><i class="ion ion-ios-paw-outline"></i></span>
            <div class="info-box-content">
                <span class="info-box-text">Jumlah Total Koleksi</span>
                <span class="info-box-number">{{ number_format($jumlah_total_koleksi, 0, '.', ',') }}</span>
            </div>
            <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{ number_format($jumlah_vertebrata, 0, '.', ',') }}</span>
            </div>
            <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
