...
<section class="content-header">
      <h1>INFORMASI KOLEKSI BATUAN & MINERAL</h1>
</section>
<section class="content">
  ...
  <div class="box-header with-border">
    <a href="{{ action('StaffDokumentasi\KoleksiController@create') }}?jenis_koleksi={{ $jenis_koleksi }}" class="btn btn-primary btn-sm active" style="float: left;" role="button" aria-pressed="true">Tambah Koleksi</a>
  </div>
